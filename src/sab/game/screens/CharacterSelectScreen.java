...
public class CharacterSelectScreen extends ScreenAdapter {
    ...
    public void render(Seagraphics g) {
        ...
        g.usefulDraw(g.imageProvider.getImage(player1Fighters.get(player1Index).id + "_render.png"), -1152 / 2, -704 / 2, 512, 512, 0, 1, 0, true, false);
        g.usefulDraw(g.imageProvider.getImage(player1Fighters.get(player1Index).id + ".png"), -1156 / 2 + 256 - player1Fighters.get(player1Index).renderWidth / 2, 704 / 2 - 160, player1Fighters.get(player1Index).renderWidth, player1Fighters.get(player1Index).renderHeight, player1Fighters.get(player1Index).walkAnimation.getFrame(), player1Fighters.get(player1Index).frames, 0, true, false);
        ...
        g.usefulDraw(g.imageProvider.getImage(player2Fighters.get(player2Index).id + "_render.png"), 1152 / 2 - 512, -704 / 2, 512, 512, 0, 1, 0, false, false);
        g.usefulDraw(g.imageProvider.getImage(player2Fighters.get(player2Index).id + ".png"), 1156 / 2 - 260 - player2Fighters.get(player2Index).renderWidth / 2, 704 / 2 - 160, player2Fighters.get(player2Index).renderWidth, player2Fighters.get(player2Index).renderHeight, player2Fighters.get(player2Index).walkAnimation.getFrame(), player2Fighters.get(player2Index).frames, 0, false, false);
