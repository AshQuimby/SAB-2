...
public class JukeboxScreen extends ScreenAdapter {
    ...
    public static void loadVanillaSongs() {
        ...
        addSong("wavezone.mp3", "Wavezone", "Beat Thorn", 144, "hyperspace.png");
        addSong("first_tough_enemy.mp3", "Wavezone", "Beat Thorn", 144, "warzone_night_background.png");
        addSong("wings_of_glory.mp3", "Wavezone", "Beat Thorn", 144, "error_background.png");
        addSong("genetically_engineered_bad.mp3", "Genetically Engineered Bad", "AshQuimby", 120, "no_ducsk.png");
        addSong("artificially_enhanced_trash.mp3", "Artificially Enchanced Trash", "AshQuimby", 120, "snas_body.png");
        addSong("walouis_sax_solo.mp3", "Walouis' Sax Solo", "Beat Thorn", 160, "warzone_background.png");
    }
