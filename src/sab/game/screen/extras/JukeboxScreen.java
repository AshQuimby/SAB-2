...
public class JukeboxScreen extends ScreenAdapter {
    ...
    public void render(Seagraphics g) {
        ...
        g.drawText(songNames.get(songIndex), Game.getDefaultFont(), 0, Game.game.window.resolutionY / 2 - 72 + 16, 2 * Game.getDefaultFontScale(), Color.WHITE, 0);

        g.drawText("-" + songCredits.get(songIndex), Game.getDefaultFont(), 0, Game.game.window.resolutionY / 2 - 128 + 16, 1.5f * Game.getDefaultFontScale(), Color.WHITE, 0);
