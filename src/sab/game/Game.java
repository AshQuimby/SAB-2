...
public class Game extends Messenger {
    ...
    public void load() {
        ...
        try {
            ...
            baseGame.addStages((Class<? extends StageType>[]) new Class<?>[]{LastLocation.class, Warzone.class, DesertBridge.class, ThumbabasLair.class, OurSports.class, COBS.class, Hyperspace.class, Boxtopia.class });
        } catch (Exception e) {
