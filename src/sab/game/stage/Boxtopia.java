...
public class Boxtopia extends StageType {
    ...
    public void init(Stage stage) {
        ...
        stage.addStageObject(new sab.game.stage.Platform(-512 / 2, -256, 512, 32, "box_bottom.png", stage));
        stage.addStageObject(new sab.game.stage.Platform(-512 / 2, -256 + 32, 32, 448, "box_left_wall.png", stage));
