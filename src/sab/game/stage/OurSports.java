...
public class OurSports extends StageType {
    ...
    @Override
    public void init(sab.game.stage.Stage stage) {
        ...
        platform = new sab.game.stage.Platform(-256 / 2, -128, 256, 24, "our_sports_platform.png", stage, new sab.game.stage.StageObjectBehaviour() {
            @Override
        ...
        stage.addLedge(new sab.game.stage.Ledge(platform, new Vector2(256 / 2, -32), 24, 32, -1));
        stage.addLedge(new Ledge(platform, new Vector2(-256 / 2 - 24, -32), 24, 32, 1));

        stage.addStageObject(platform);

        stage.addStageObject(new sab.game.stage.StageObject(-256 / 2, -128 - 704 + 24, 256, 704, "our_sports_platform_supports.png", stage, new sab.game.stage.StageObjectBehaviour() {
            @Override
            public void update(sab.game.stage.StageObject stageObject, Battle battle) {
                if (stormy) {
        ...
        stage.addStageObject(new sab.game.stage.StageObject(-256 / 2, -128 - 704 + 24, 256, 704, "our_sports_platform_supports_solo.png", stage));

        platform = new sab.game.stage.Platform(-192 / 2, -128, 192, 24, "our_sports_platform_white_ring.png", stage, new StageObjectBehaviour() {
            @Override
    ...
    @Override
    public void renderOverlay(sab.game.stage.Stage stage, Seagraphics g) {
        if (lightning > 0) {
