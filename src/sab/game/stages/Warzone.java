...
public class Warzone extends StageType {
    ...
    public void init(Stage stage) {
        ...
        stage.addStageObject(new PassablePlatform(-512 / 2, 0, 124, 20, "warzone_platform.png", stage));
        stage.addStageObject(new PassablePlatform(-124 / 2, 64, 124, 20, "warzone_platform.png", stage));
