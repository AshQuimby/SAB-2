...
public class COBS extends StageType {
    ...
    public void init(Stage stage) {
        ...
        Platform platform = new Platform(-280 / 2 - 280 - 100, -128, 280, 72, "ruined_platform_1.png", stage, new StageObjectBehaviour() {
            @Override
        ...
        platform = new Platform(-280 / 2, -128, 280, 72, "ruined_platform_2.png", stage, new StageObjectBehaviour() {
            @Override
            public void update(StageObject stageObject, Battle battle) {
